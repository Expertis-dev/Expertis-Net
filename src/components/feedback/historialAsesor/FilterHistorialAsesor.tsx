export const FilterHistorialAsesor = () => {
    return (
        <div className="flex flex-row items-center justify-between gap-2 border border-gray-200 dark:border-zinc-700 px-4 mx-2 bg-white shadow-sm dark:bg-zinc-800">
            ...
            <div className="w-full sm:w-auto flex items-center gap-2">
                ...
                <input
                    type="month"
                    id="mes-anio"
                    className="w-full dark:bg-zinc-500 dark:text-gray-200 dark:border-zinc-700 sm:w-64 bg-gray-50 border border-gray-200 text-gray-800 text-sm px-4 py-2 outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 my-2 transition-all cursor-pointer font-medium"
                />
            </div>
        </div>
    )
