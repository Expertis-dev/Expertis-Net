...
export const HeaderCrearFbAsesor = () => {
    return (
        <>
            <div className="flex flex-row bg-zinc-50 p-2 border shadow rounded-xs dark:bg-zinc-900 dark:border-zinc-700">
                <div className="flex flex-col px-2 flex-3/4">
                    ...
                    <div className="flex flex-row border w-100 p-1 bg-white rounded-xs dark:bg-zinc-800 dark:border-zinc-600">
                ...
                <div className="flex flex-col px-4">
                    ...
                    <div className="flex-1/3 flex flex-row bg-zinc-300 rounded-xs dark:bg-zinc-700">
                        <div className="flex-1 m-1 mr-2 px-1 py-0.5 hover:cursor-pointer bg-zinc-50 rounded-xs dark:bg-zinc-900">
            ...
            <div className="flex flex-col p-2 mt-2 border shadow bg-zinc-200 rounded-xs dark:bg-zinc-800 dark:border-zinc-700">
