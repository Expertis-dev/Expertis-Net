    ...
    return (
        <main className="flex justify-center px-4 py-8">
            <section className="w-full max-w-3xl">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="bg-white dark:bg-zinc-800 rounded-xl shadow-sm p-6 space-y-6 border border-gray-100 dark:border-zinc-700">
                                                            ...
                                                            {pregunta.options?.map((o) => {
                                                                ...
                                                                return (
                                                                    <label key={o.label} className="inline-flex items-center gap-2 cursor-pointer">
                                                                        ...
                                                                        />
                                                                        <span className="w-5 h-5 rounded-sm border border-gray-300 dark:border-zinc-600 flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 transition">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-4">
                        <button type="button" onClick={() => reset()} className="px-4 py-2 rounded-md bg-gray-100 dark:bg-zinc-700 text-gray-800 dark:text-gray-200 hover:bg-gray-200 transition">Limpiar</button>
