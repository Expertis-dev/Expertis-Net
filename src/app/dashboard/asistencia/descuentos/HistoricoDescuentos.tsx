      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        >
          <TabsList className="bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-1 rounded-xl h-11">
            ...
            <TabsTrigger value="Tardanza" className="rounded-lg px-6">Tardanza</TabsTrigger>
            <TabsTrigger value="Falta" className="rounded-lg px-6">Falta</TabsTrigger>
          </TabsList>
        </Tabs>
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <Input 
            ...
            value={colabordaorFiltro}
            onChange={(e)=>setColabordaorFiltro(e.target.value)}
          />
        </div>
      </div>
        ...
        <CardContent className="p-0">
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 text-center">
              ...
              <tbody className="divide-y divide-slate-50 dark:divide-slate-900 text-center">
                {logs.map((log, i) => (
