        ...
        <>
            ...
            <div className="flex flex-row justify-between mb-4 mx-2">
                ...
                <div className="flex flex-auto justify-end">
                    <Button className="mr-2.5 dark:bg-green-700 bg-green-600 mt-1 dark:text-gray-200 dark:hover:bg-green-900" >
                        <SheetIcon />
                        Exportar a Excel
                    </Button>
                    <Link
                    ...
                    >
                        <Button className="dark:bg-blue-800 bg-blue-600  mt-1 dark:text-gray-200 dark:hover:bg-blue-900">
                            <h2>+</h2>
                            <h2>Nueva Entrada</h2>
                        </Button>
                    </Link>
